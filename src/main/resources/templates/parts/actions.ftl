   ...
   <div class="col-sm">
    ...
    <div class="collapse <#--<#if message??>show</#if>-->" id="transactForm">
        ...
        <div class="form-check">
            <input class="form-check-input" onclick="accToAccTrans()" type="radio" name="transType" id="selfTrans" value="option1" checked>
            <label class="form-check-label" for="selfTrans">
                Transaction over my accounts
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" onclick="accToUserTrans()" type="radio" name="transType" id="toUserTrans" value="option2">
        ...
        <form class="form" method="post" name="test" id="transactForm" action="/transactions/new">
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input class="form-control" id="ammountform" type="number" min="0" step="0.01" name="ammount"
...
<#macro addMoney>
    ...
    <div class="collapse <#--<#if message??>show</#if>-->" id="addMoneyForm">
